<template>
    <div>
        <div v-if="$page.props.flash.element == 'flash-success' && show"
        ...
        <div v-if="$page.props.flash.element == 'flash-error' && show"
            ...
            <div class="flex items-center">
                ...
                <div v-if="$page.props.flash.message" class="py-4 text-white text-sm font-medium">{{
